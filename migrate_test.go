...
import (
	dStub "github.com/floatdrop/migrate/v4/database/stub"
	"github.com/floatdrop/migrate/v4/source"
	sStub "github.com/floatdrop/migrate/v4/source/stub"
)
...
func ExampleNewWithDatabaseInstance() {
	...
	// `import "github.com/floatdrop/migrate/v4/database/postgres"`
...
func ExampleNewWithSourceInstance() {
	...
	// `import "github.com/floatdrop/migrate/v4/source/stub"`
